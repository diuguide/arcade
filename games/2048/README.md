# 2048 
  ...
  * [Questions](#questions)
  # Project Description
  This is a build of the game 2048
  # Installation
  
  # Usage
  The user may use this app through the browser.  I am going to build a front end 'arcade' to handle the arcade games, for now they will be stored in this repo.
  # Tests
